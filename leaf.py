...
filepath = 'C:/Users/HIMA BINDU/OneDrive/Desktop/New folder/Plant-Leaf-Disease-Prediction-main/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('D:/c/nani/nani/Plant-Leaf-Disease-Prediction-main/Plant-Leaf-Disease-Prediction-main', filename)
        file.save(file_path)
